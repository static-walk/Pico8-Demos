...
This a gallery of some of the demos I created for the [Pico-8](https://www.lexaloffle.com/pico-8.php) fantasy console.

![1D Kohonen Network](/GIFs/1d_kohonen_network.gif)

[1D Kohonen Network](/Demos/1d_kohonen_network.p8)

![10 PRINT CHR$(205.5+RND(1)); : GOTO 10](/GIFs/10_print_chr.gif)
